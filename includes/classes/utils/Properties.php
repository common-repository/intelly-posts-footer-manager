...
class IPFM_Properties {
    ...
    private function encode($t, $v) {
        ...
        switch (strtolower($t)) {
            ...
            case 'f':
                ...
                break;
            case 'd':
                $v=$ipfm->Utils->formatDatetime($v);
                break;
            case 'b':
                $v=($ipfm->Utils->isTrue($v) ? 'true' : 'false');
                break;
            case 'a':
    ...
    private function decode($t, $v) {
        ...
        switch (strtolower($t)) {
            ...
            case 'f':
                ...
                break;
            case 'd':
                $v=$ipfm->Utils->parseDateToTime($v);
                break;
            case 'b':
    ...
    public function getFile($key, $default=FALSE) {
        ...
        if(is_dir($file)) {
            ...
            $file=str_replace("/", DIRECTORY_SEPARATOR, $file);
            if(!$ipfm->Utils->endsWith($file, DIRECTORY_SEPARATOR)) {
